<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="row">
  		<div class="col-12">
  			...
  			<a href="/CNJava/chitietloaisanpham/${LoaiMay.idLoaiMay}" style="color: red"> ${LoaiMay.tenLoaiMay}</a> >
	...
	<div class="row" style="margin-top:20px;margin-bottom:20px;">
    	...
    	<c:if test="${Gia == '1-5000000'}">
    		<div class="col-10">
    			...
    			<a href="/CNJava//sanphamtheonhasanxuat/${NhaSanXuat.idNhaSanXuat}/${LoaiMay.idLoaiMay}"><button type="button" class="btn btn-secondary">X</button></a>
    		</div>
    	</c:if>
				      ...
				      <div class="modal-body">
				          ...
				          <span aria-hidden="true">&times;</span>
				       	...
				       	<div class="row" style="margin:20px;">
						    ...
						    <div class="col-6">
						      <c:if test="${Loai==1}">
						      <form action="/CNJava/sanphamtheonhasanxuat/phantrang/${NhaSanXuat.idNhaSanXuat}/${LoaiMay.idLoaiMay}/${Trang+1}/addquickview/${item.idSanPham}" method="post">
						      </c:if>
						      <c:if test="${Loai==2}">
						      <form action="/CNJava/sanphamtheonhasanxuat/phantrang/${NhaSanXuat.idNhaSanXuat}/${LoaiMay.idLoaiMay}/${Gia}/${Trang+1}/addquickview/${item.idSanPham}" method="post">
						      </c:if>
				...
				<nav aria-label="Page navigation example">
				  <ul class="pagination">
				    <li class="page-item <%=trang==0 ? "disabled" : ""%>">
				      <a class="page-link" href="/CNJava/sanphamtheonhasanxuat/phantrang/${NhaSanXuat.idNhaSanXuat}/${LoaiMay.idLoaiMay}/<%=trang %>" aria-label="Previous">
				    ...
				    %>
			    		<li class="page-item <%=i==trang ? "active" : "" %>"><a class="page-link" href="/CNJava/sanphamtheonhasanxuat/phantrang/${NhaSanXuat.idNhaSanXuat}/${LoaiMay.idLoaiMay}/<%=i+1 %>" ><%=i+1 %></a></li>
				    <%		
				    	}
				    %>
				    <li class="page-item <%=trang+1==soTrang ? "disabled" : ""%>">
				      <a class="page-link" href="/CNJava/sanphamtheonhasanxuat/phantrang/${NhaSanXuat.idNhaSanXuat}/${LoaiMay.idLoaiMay}/<%=trang+2 %>" aria-label="Next">
   		...
   		<div class="col-12">
		   	<div class="pagination-0" style="margin-top:20px;float:right;">
				<nav aria-label="Page navigation example">
				  <ul class="pagination">
				    <li class="page-item <%=trang==0 ? "disabled" : ""%>">
				      <a class="page-link" href="/CNJava/sanphamtheonhasanxuat/phantrang/${NhaSanXuat.idNhaSanXuat}/${LoaiMay.idLoaiMay}/${Gia}/<%=trang %>" aria-label="Previous">
				        <span aria-hidden="true">&laquo;</span>
				        <span class="sr-only">Previous</span>
				      </a>
				    </li>
			    	<%
				    	...
				    	for(int i = 0; i < soTrang; i++){
				    %>
			    		<li class="page-item <%=i==trang ? "active" : "" %>"><a class="page-link" href="/CNJava/sanphamtheonhasanxuat/phantrang/${NhaSanXuat.idNhaSanXuat}/${LoaiMay.idLoaiMay}/${Gia}/<%=i+1 %>" ><%=i+1 %></a></li>
				    <%		
				    	}
				    %>
				    <li class="page-item <%=trang+1==soTrang ? "disabled" : ""%>">
				      <a class="page-link" href="/CNJava/sanphamtheonhasanxuat/phantrang/${NhaSanXuat.idNhaSanXuat}/${LoaiMay.idLoaiMay}/${Gia}/<%=trang+2 %>" aria-label="Next">
				        <span aria-hidden="true">&raquo;</span>
				        <span class="sr-only">Next</span>
				      </a>
				    </li>
